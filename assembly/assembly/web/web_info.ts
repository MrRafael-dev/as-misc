...
export const webMethods: Set<string> = new Set<string>()
  .add("GET")
  .add("HEAD")
  .add("POST")
  .add("PUT")
...
/** Códigos de status HTTP válidos. */
export const webStatus: Map<i32, string> = new Map<i32, string>()
  .set(100, "Continue")
